...
[Stake2 and Funkysnipa Cat](https://thestake2.netlify.app/Stake2/)
...
The content of the ["Watched media"](https://thestake2.netlify.app/Watch%20History/?tab=watched_media) and ["Past registries"](https://thestake2.netlify.app/Watch%20History/?tab=past_registries) tabs on the "Watch History" website are inside JSON files.<br>
...
The content of the ["Gaming sessions played"](https://thestake2.netlify.app/Play%20History/?tab=gaming_sessions_played) and ["Past registries"](https://thestake2.netlify.app/Play%20History/?tab=past_registries) tabs on the "Play History" website are inside JSON files.<br>
...
[My 2025](https://thestake2.netlify.app/2025/)

[My 2026](https://thestake2.netlify.app/2026/)
...
## "Watched media" tabs on all year websites
The content of the "Watched media" tab of the "Watch History" website and all year websites are inside JSON files.<br>
The JSON database files are created and filled by the ["Watch_History.py"](https://github.com/Stake2/Python/tree/main/Modules/Watch_History) Python module.<br>
The JSON database files are read by the ["Watched.php"](https://github.com/Stake2/PHP/blob/main/Websites/Watch%20History/Generators/Watched.php) HTML tab generator written in PHP, and the tabs are created.<br>

## "Gaming sessions played" tabs on all year websites
The content of the "Gaming sessions played" tab of the "Play History" website and all year websites are inside JSON files.<br>
The JSON database files are created and filled by the ["GamePlayer.py"](https://github.com/Stake2/Python/tree/main/Modules/GamePlayer) Python module.<br>
The JSON database files are read by the ["Played.php"](https://github.com/Stake2/PHP/blob/main/Websites/Play%20History/Generators/Played.php) HTML tab generator written in PHP, and the tabs are created.<br>
